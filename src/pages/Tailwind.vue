    ...
    <main>
      ...
      <article class="max-w-xl md:max-w-2xl xl:max-w-3xl mx-auto px-6 sm:px-12 pt-16 border-b border-gray-300 pb-10 mb-16">
        <div class="markdown text-lg leading-normal text-gray-700">
          <p>Software engineer with entrepreneurial background, based in São Paulo and currently working at Collabora.
            Fully engaged on creating products to impact society positively or just for fun. Fights for more diversity
            in tech and equal opportunities for everyone.</p>
        </div>
      </article>
      ...
      meta: [
        {
          key: 'description',
          name: 'description',
          content: 'Ana Root\'s random thoughts about life and code.'
        },

        { property: "og:type", content: 'article' },
        { property: "og:title", content:'About' },
        { property: "og:description", content: 'About me and this blog.' },
        { property: "og:url", content: `${this.config.siteUrl}/about/` },
        { property: "og:image", content: '/images/card.png' },

        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: 'About' },
        { name: "twitter:description", content: 'About me and this blog.' },
