  ...
  metaInfo () {
    return {
      ...
      meta: [
        ...
        { property: "og:title", content: `Posts written by ${this.$page.author.title}` },
        { property: "og:description", content: `Browse posts written by ${this.$page.author.title}` },
        { property: "og:url", content: `${this.config.siteUrl}/${this.$page.author.path}/` },
        { property: "og:image", content: this.ogImageUrl },

        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: `Posts written by ${this.$page.author.title}` },
        { name: "twitter:description", content: `Browse posts written by ${this.$page.author.title}` },
